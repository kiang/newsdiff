...
<div id="TagsAdminIndex">
    ...
    <div class="btn-group">
        ...
        <?php echo $this->Paginator->sort('Tag.count', '數量排序', array('url' => $url, 'class' => 'btn btn-default')); ?>
        <?php echo $this->Paginator->sort('Tag.created', '時間排序', array('url' => $url, 'class' => 'btn btn-default')); ?>
    </div>
